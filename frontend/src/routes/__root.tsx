...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Commoda — Commodity Price Drop Protection" },
      {
        name: "description",
        content:
          "Fixed-payout protection against commodity price drops on WTI, Brent and Natural Gas, settled from independently verified market data.",
      },
      { name: "author", content: "Commoda" },
      { property: "og:title", content: "Commoda — Commodity Price Drop Protection" },
      {
